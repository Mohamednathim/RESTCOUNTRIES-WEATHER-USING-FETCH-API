...
header.className = " text-center fs-1 bg-info";
header.id = "title";
header.textContent = "COUNTRY & WEATHER USING FETCH API";
...
fetch("https://restcountries.com/v3.1/all")
  ...
  .then((data) => {
    data.forEach((element) => {
      ...
      card.innerHTML = `<h3 class="text-center bg-black text-light p-2" id="countryName">${CountryName}</h3>

        <img class="card-img img-fluid img-thumbnail" src="${flag}" alt="Card image" style="height:250px;object-fit:contain" />
...
// adding Event listener for through document for updating weather
